...
Every input each reusable workflow accepts, with its default. `–` means the
workflow does not accept that input, so a caller cannot set it there.
...
|---|---|---|---|---|---|---|---|---|---|
| `system-deps` | `true` | `true` | &ndash; | &ndash; | &ndash; | `true` | `true` | `true` | `true` |
| `pandoc` | `true` | `true` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `extra-env` | `""` | `""` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `dependencies` | `"all"` | `"all"` | &ndash; | `"all"` | &ndash; | `"all"` | &ndash; | &ndash; | &ndash; |
| `extra-packages` | `""` | `""` | `""` | `""` | `""` | `""` | &ndash; | &ndash; | &ndash; |
| `post-install` | `""` | `""` | `""` | `""` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `extra-repositories` | `https://PredictiveEcology.r-unive`… | &ndash; | &ndash; | &ndash; | `""` | &ndash; | &ndash; | &ndash; | &ndash; |
| `extra-apt` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | `""` | `""` | `""` |
| `cache-version` | `1` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `error-on` | `"warning"` | &ndash; | &ndash; | `"error"` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `check-args` | `c("--no-manual", "--as-cran")` | &ndash; | &ndash; | `c("--no-manual", "--as-cran", "--`… | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `build-args` | `c("--no-manual", "--compact-vigne`… | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `extra-config` | `[]` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `r-version` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | `release` | `release` | `release` |
| `module` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | **required** | **required** | **required** |
| `coverage` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | `true` | &ndash; |
| `url` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | `""` |
| `config` | &ndash; | &ndash; | &ndash; | &ndash; | `[{"os": "ubuntu-latest", "r": "re`… | &ndash; | &ndash; | &ndash; | &ndash; |
| `cranonly` | &ndash; | &ndash; | &ndash; | &ndash; | `true` | &ndash; | &ndash; | &ndash; | &ndash; |
| `quiet` | &ndash; | &ndash; | &ndash; | &ndash; | `true` | &ndash; | &ndash; | &ndash; | &ndash; |
| `timeout` | &ndash; | &ndash; | &ndash; | &ndash; | `30` | &ndash; | &ndash; | &ndash; | &ndash; |
| `downstream` | &ndash; | &ndash; | &ndash; | **required** | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
| `run-in-tmux` | &ndash; | `false` | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; | &ndash; |
...
|---|---|---|---|---|---|---|---|---|---|
| Uses `setup-r-deps` | yes | &ndash; | &ndash; | &ndash; | &ndash; | yes | &ndash; | &ndash; | &ndash; |
| Honours `[skip-ci]` | yes | yes | yes | yes | yes | &ndash; | yes | yes | yes |
| Cancels superseded PR runs | yes | yes | &ndash; | yes | yes | &ndash; | yes | yes | yes |
| Dependency source | input, r-universe by default | r-universe, fixed | r-universe, fixed | r-universe, fixed | input, CRAN by default | CRAN only | Require | Require | Require |
